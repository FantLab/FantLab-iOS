...
final class WorkChildLayoutSpec: ModelLayoutSpec<WorkChildLayoutModel> {
    override func makeNodeFrom(model: WorkChildLayoutModel, sizeConstraints: SizeConstraints) -> LayoutNode {
        let work = model.work
